public class SoldState implements IGumballMachine 
{
    ...
    public void turnCrank()
    {
      ...
      /* if (gumballMachine.getCount() >0 && gumballMachine.getCost() >= 50 && gumballMachine.getGumballStatus() == true)
        {
        ...
        else if (gumballMachine.getCount() > 0 && gumballMachine.getCost() < 50 && gumballMachine.getGumballStatus() == true)
        {
    ...
    public void takeGumballFromSlot() 
    {
        if (gumballMachine.getCount() > 0 ) 
        {
            System.out.println("Please wait....picking up gumball/s from slot.");
            System.out.println("Collected" + " gumballs from slot" );
        ...
        else
        {
            if (gumballMachine.getCost() > 0)
            {
                ...
                System.out.println("The nice gumball machine is returning your "+ gumballMachine.getCost() + " Cents");
            }
